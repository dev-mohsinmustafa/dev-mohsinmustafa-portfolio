...
const About = () => {
  return (
    <>
      ...
      >
        With a proven track record as a Full Stack Developer and overall 2 + years hands-on expertise in HTML5, CSS3, Bootstrap5, TailwindCSS, Flowbite, Ant Design, JavaScript, ReactJS, React Native, Google Firebase, MongoDB, and
