    ...
    <section className='relative w-full h-screen lg:h-[900px] mx-auto'>
      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} text-white-100 mt-2`}>I develop cutting-edge web and mobile apps using <br className='sm:block hidden' /> ReactJs and React Native.</p>
      ...
      <div className='absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center'>
        {/* <Link href="/about"> */}
          <div className='w-[35px] h-[64px] rounded-3xl border-4
           border-secondary flex justify-center items-start p-2 cursor-pointer'
